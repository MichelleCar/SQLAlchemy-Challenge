...
def welcome():
    ...
    return (
        f"Welcome to our Hawaii climate site!<br/>"
...
def stations():
    ...
    # Convert list of tuples into normal list (https://www.geeksforgeeks.org/python-convert-list-of-tuples-into-list/)
...
def tobs():
    ...
    tobs = list(np.ravel(temp_active_stn))

    # return the JSON representation of the dictionary
    return jsonify(tobs)

# ________________________________________________________________
# Return a JSON list of the minimum, average, and maximum temperatures for specific start date
# and/or start-end range
